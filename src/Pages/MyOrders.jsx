                        ...
                        <div className="mt-8">
                            {savedOrders.length === 0 ? (
                                <div className="text-center">
                                    <ShoppingCart className="mx-auto mb-4 w-150 h-150" />
                                    <h2 className="text-2xl font-semibold text-gray-700">No Orders Yet</h2>
                                    <p className="mt-2 text-gray-600">You haven't placed any orders yet. Start shopping now!</p>
                                    <button
                                ...
                                <>
                                    <ul className="space-y-4 h-[45vh] overflow-y-auto custom-scrollbar">
                                                ...
                                                <li className="flex items-center gap-4" key={order.id}>
                                                    ...
                                                    <div>
                                                        <h3
                                                            ...
                                                            className="text-sm text-gray-900 font-bold cursor-pointer">ORDER #{lastSixDigits}</h3>
